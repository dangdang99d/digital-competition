...
|---|---|:--:|---|---|---|
| E9 | loss screen: CE / focal / LS | ✅ | LS 0.7565 · focal 0.7403 | LS **+0.0107** · focal −0.0055 | LS PROMOTED; focal closed |
| E11 | TAPT (granite MLM on 70k texts) | ✅ | **0.7592** | **+0.0134** | WIN — cheap domain gain |
| E13 | SAM fine-tune | ❌ | — | — | CLOSED by analysis (no run) |
| E14 | session-grouped split | 🟡 | — | — | low prio, not run |
| E10 | ensemble → single distillation | 🕐 | — | — | deferred to pre-deadline |
