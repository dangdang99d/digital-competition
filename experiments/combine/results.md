...
| E8a+LS | E8a + label-smoothing ε=0.1 | granite | 🏆 | **0.7803** | +0.0097 vs E8a | **BEST — top submission** |
| E12 | model soup, 3 seeds | granite | ⚠️ | 0.7803/0.7758/0.7628 | n/a | BOTCHED — re-run split-fixed |
