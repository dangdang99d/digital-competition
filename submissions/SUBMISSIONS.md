...
| E26-C | **3-granite ensemble** is3 + e22_aum06 + e25c-richmeta | granite-311m ×3 | richargs ×2 + richmeta · vocab-prune union · fp16 · bs 256 | **no** | **0.7850** ens (3.5k slice) | **836M** | est ~6:45 (3 × measured ~2:15) | — | ⬆ **BUILT `submit_0710_ens3_is3_aum06_richmeta.zip`, ready to upload** (parity skipped — pipeline LB-validated by E26-A/B; is3+e25c already LB-proven members, aum06 same-family via same prune path). Tests: does a 3rd diverse member extend the pair gain? |
